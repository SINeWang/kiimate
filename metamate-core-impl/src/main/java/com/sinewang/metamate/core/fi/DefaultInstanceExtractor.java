...
public class DefaultInstanceExtractor implements AnInstanceExtractor {
    ...
    @Override
    public List<Instance> extract(String group, String name, String tree, String ownerId, String operatorId, Map<String, String[]> map) {
        ...
        for (String field : map.keySet()) {
            ...
            String[] both = ArrayUtils.addAll(new String[]{id}, values);
